...
RUN apt-get install -y curl git php5 libapache2-mod-php5 php5-cli php5-dev php5-mysql php5-xmlrpc php5-curl php5-gd php-apc php-pear php5-imap php5-mcrypt php5-pspell php5-redis
